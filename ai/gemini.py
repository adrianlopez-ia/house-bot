...
class GeminiAnalyzer:
    ...
    async def analyze_page_and_forms(
        ...
        prompt = (
            "Eres un analista experto y ESCEPTICO del mercado inmobiliario de Madrid.\n"
            "Tu trabajo es extraer SOLO oportunidades de vivienda REALES de esta pagina web.\n\n"
            "CRITERIOS DE FILTRADO:\n"
            "- IGNORA definiciones de diccionario, articulos de noticias generales que no hablen de un proyecto especifico, "
            "servicios de alarmas, hoteles, viajes o transporte.\n"
            "- SOLO extrae informacion si hay indicios de una promocion, edificio, cooperativa o proyecto concreto.\n"
            "- Si no encuentras NADA que sea una oportunidad de vivienda real, devuelve arrays vacios.\n\n"
            "IMPORTANTE:\n"
            "- Busca promociones, proyectos residenciales, cooperativas, obra nueva.\n"
            "- Si la pagina lista varias promociones, extrae CADA UNA como oportunidad separada.\n"
            "- Si solo hay informacion general de UNA promocion, extrae esa como oportunidad.\n"
            "- Busca tambien formularios de contacto o inscripcion especificos para estas viviendas.\n\n"
            f"URL: {url}\n"
